...
#
#@MD5TINOIGN@ Creation date: Thu Jun 23 21:47:25 CEST 2016
#
# This file is based on following files:
#@MD5TINOIGN@ 1: Makefile.tino
#@MD5TINOIGN@ 2: /git/git/src/slowdown/tino/Makefile.proto
...
#
#@MD5TINOIGN@ included: /git/git/src/slowdown/tino/Makefile.proto
#
...
# included: slowdown.d
$(PROG1).o:  slowdown.c slowdown_version.h
